# 🔧 Forge Kernel – The Core Stuff

Hey! 👋 This is the core of the Forge Framework—where all the essential pieces come together. If you're wondering how Forge actually _runs_, this is the place to be.
...
Eventually, some parts like the bootstraps will become their own modules to keep the kernel lean and mean—but for now, it’s all bundled together here.
...
Check out the [Modules Registry](https://github.com/forge-kernel/modules) for the official modules, and the [Forge Starters](https://github.com/forge-kernel/starter-templates) if you want to kick off a new project.
