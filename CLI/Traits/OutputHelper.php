        ...
        return match ($commandType) {
            'component' => [
                ...
                'messages' => [
                    ...
                    '',
                    'Component location: ' . ($type === 'app' ? 'app/resources/components/' : "modules/{$module}/src/Resources/components/"),
            ...
            'layout' => [
                ...
                'messages' => [
                    ...
                    'Layout location: ' . ($type === 'app' ? 'app/resources/views/layouts/' : "modules/{$module}/src/Resources/views/layouts/"),
                ],
            ],
            'controller' => [
